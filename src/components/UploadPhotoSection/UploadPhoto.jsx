...
const UploadPhoto = () => {
  ...
  const generateCroppedImage = async () => {
    ...
    setCroppedImage(url); // Set the cropped image URL for display
    return blob; // Return blob to be used for prediction
  };
      ...
      {!imageSrc && (
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Select a photo to analyze. You can upload a file from your device.
          </p>
          <input
            type="file"
            accept="image/*"
